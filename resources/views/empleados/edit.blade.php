        ...
        <form action="{{ route('empleados.update', $empleado->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea name="descripcion" id="descripcion" rows="3"
                          class="form-control" placeholder="Descripción de la experiencia del empleado" required>{{ old('descripcion', $empleado->descripcion) }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <div>
                    @php
                        $rolesSeleccionados = old('roles', $empleado->roles->pluck('id')->toArray());
                    @endphp
